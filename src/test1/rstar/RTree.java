...
* the header of the RStarTree is organised as follows:
* +-----------+-------------+---------------+---------------+--------------+------+
...
public final class RTree
{
    ...
    /*
        ...
        { error("RStarTree::erase: not implemented", false); }
    #endif
    */
    ...
    */
    ...
    // neuen R-Baum konstruieren
    {
        ...
        {
            Constants.error("RStarTree creation: error in block file initialization", true);
        }
    ...
    */
    ...
    // bereits vorhandenen R-Baum laden
    {
        ...
        {
            Constants.error("RStarTree reading: error in block file initialization", true);
        }
        ...
        {
            Constants.error("RStarTree header reading: error in block file initialization", true);
        }
    ...
    /**
    * read serialized information from buffer to RStarTree variables
    */
    ...
    /**
    * store RStarTree information to buffer serially
    */
        ...
        */
        ...
        while (re_data_cands.get_num() > 0)
        {
            ...
            if (d_cand != null)
            {
                ...
                Constants.error("RStarTree::insert: inconsistent list re_data_cands", true);
    ...
    */
    ...
    #ifdef S3
    template <class Data>
    void RStarTree<Data>::neighbours(LinList<Data> *sl,
                float eps,
                Result *rs,
                norm_ptr norm)
    {
    ...
    */
    ...
    /*
    void RStarTree<Data>::writeinfo(FILE *f)
    {
        load_root();
    ...
    */
    ...
    protected void delete ()
    {
        ...
        {
            Constants.error("RStarTree.delete: error in writing header", true);
        }
        if (root_ptr != null)
        {
        ...
        {
            Constants.error("RStarTree.delete: error in flushing file", true);
        }
